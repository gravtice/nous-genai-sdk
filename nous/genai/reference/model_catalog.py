...
SUPPORTED_TESTS: dict[str, list[str]] = {
    "openai": ["chat", "tools", "transcription", "image", "video", "audio", "embedding"],
    "anthropic": ["chat", "tools"],
    "google": ["chat", "tools", "transcription", "image", "video", "audio", "embedding"],
    "volcengine": ["chat", "image", "video", "embedding"],
    "aliyun": ["chat", "transcription", "image", "video", "audio", "embedding"],
    "tuzi-web": ["chat", "tools", "transcription", "image", "video", "audio", "embedding"],
    "tuzi-openai": ["chat", "tools", "transcription", "image", "video", "audio", "embedding"],
    "tuzi-google": ["chat", "tools", "transcription", "image", "video", "audio", "embedding"],
